...
import com.example.ppjoke.databinding.LayoutRefreshViewBinding;
...
public abstract class AbsListFragment<T, M extends AbsViewModel<T>> extends Fragment implements OnRefreshListener, OnLoadMoreListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        decoration.setDrawable(ContextCompat.getDrawable(getContext(), com.example.ppjoke.R.drawable.list_divider));
