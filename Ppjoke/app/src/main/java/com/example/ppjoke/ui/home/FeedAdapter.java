...
import com.example.libcommon.global.extention.LiveDataBus;
...
public class FeedAdapter extends AbsPagedListAdapter<Feed, FeedAdapter.ViewHolder> {
    ...
    public int getItemViewType2(int position) {
        ...
        if (feed.itemType == Feed.TYPE_IMAGE_TEXT) {
            return com.example.ppjoke.R.layout.layout_feed_type_image;
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bindData(Feed item) {
            ...
            mBinding.setVariable(com.example.ppjoke.BR.lifeCycleOwner, mContext);
