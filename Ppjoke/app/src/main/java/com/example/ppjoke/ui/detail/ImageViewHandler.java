...
import com.example.ppjoke.databinding.ActivityFeedDetailTypeImageBinding;
import com.example.ppjoke.databinding.LayoutFeedDetailTypeImageHeaderBinding;
import com.example.ppjoke.model.Feed;
import com.example.ppjoke.view.PPImageView;
...
public class ImageViewHandler extends ViewHandler {
    ...
    public ImageViewHandler(FragmentActivity activity) {
        super(activity);
        mImageBinding = DataBindingUtil.setContentView(activity, com.example.ppjoke.R.layout.activity_feed_detail_type_image);
