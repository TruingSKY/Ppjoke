...
public class FullScreenPlayerView extends ListPlayerView {
    ...
    public FullScreenPlayerView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        exoPlayerView = (PlayerView) LayoutInflater.from(context).inflate(com.example.ppjoke.R.layout.layout_exo_player_view, null, false);
    }
    ...
    protected void setSize(int widthPx, int heightPx) {
        ...
        LayoutParams coverLayoutParams = (LayoutParams) cover.getLayoutParams();
